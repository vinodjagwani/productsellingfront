 ...
 *  
 */
package de.hybris.platform.productsellingfront.jalo;
...
import de.hybris.platform.productsellingfront.constants.ProductsellingfrontConstants;



/**
 * This is the extension manager of the Productsellingfront extension.
 */
public class ProductsellingfrontManager extends GeneratedProductsellingfrontManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ProductsellingfrontManager.class.getName());
	 ...
	 */
	public static ProductsellingfrontManager getInstance()
	{
		return (ProductsellingfrontManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ProductsellingfrontConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ProductsellingfrontManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ProductsellingfrontManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ProductsellingfrontManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ProductsellingfrontManager called, current tenant: " + getTenant().getTenantID());
		}
	}
